...
document.getElementById(
  "date"
).innerHTML = `Сегодня: ${dayOfWeek}, ${d.getDate()} ${month} ${d.getFullYear()} г.`;
...
faqs.forEach((faq) => {
  ...
  question.addEventListener("click", () => {
    faqs.forEach((faqItem) => {
      const otherAnswer = faqItem.querySelector(".answer");
      const otherToggle = faqItem.querySelector(".toggle");

      if (faqItem !== faq && otherAnswer.style.display === "block") {
